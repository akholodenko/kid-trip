  ...
  [0],
  {
    ...
    204: function(e, t, n) {
      ...
      var a = n(31),
        ...
        C = S('family-biking-cmp.jpg', '700px'),
        w = function() {
        ...
        pe = Object(le.a)({
          ...
          return o.a.createElement(
            ...
            o.a.createElement(
              ...
              o.a.createElement(
                x.a,
                { variant: 'h6', component: de.b, to: O.venuePath(t.slug) },
                t.name
              )
            ),
            o.a.createElement(
              ...
              (function(e, t) {
                ...
                switch (e.venueTypes[0].name) {
                  case 'restaurant':
                    n = o.a.createElement(ce.a, { className: t })
                    break
                  case 'outdoor playground':
                    n = o.a.createElement(ue.a, { className: t })
                    break
                  default:
                    n = o.a.createElement(se.a, { className: t })
                }
                return n
              })(t, 'venueIcon'),
              ...
              o.a.createElement(
                'a',
                { href: me(t), target: '_blank', rel: 'noopener noreferrer' },
                t.city,
                ', ',
                t.state
              )
      ...
      var ke = M()(Ne()),
        ...
        qe = function(e) {
          var t = e.onVenueTypeSelected,
            ...
            i = a[0],
            l = a[1]
          return o.a.createElement(Ue.b, { query: oe }, function(e) {
            var n = e.loading,
              a = e.error,
              r = e.data
            if (n) return 'Loading...'
            ...
            return o.a.createElement(
              Te.a,
              { style: Me.formControl },
              o.a.createElement(Ie.a, { htmlFor: 'age-simple' }, 'Venue Type'),
              o.a.createElement(
                Be.a,
                {
                  value: i,
      ...
      var We = M()(Le()),
        ...
        Qe = function(e) {
          var t = Object(He.a)(We, {
              ...
              refetchQueries: [{ query: re }]
            }),
            n = Object(_.a)(t, 1)[0],
            i = Object(r.useState)(Object(a.a)({}, Pe)),
            l = Object(_.a)(i, 2),
            c = l[0],
            u = l[1],
            s = Object(r.useState)('Please enter information about a venue'),
            m = Object(_.a)(s, 2),
            d = m[0],
            p = m[1],
            f = function(e) {
              return function(t) {
                console.log(e, t.target.value),
                  u(Object(a.a)({}, c, Object(fe.a)({}, e, t.target.value)))
              }
            }
          return o.a.createElement(
            ve.a,
            ...
            o.a.createElement(he.a, { style: Ge.title }, 'Add New Destination'),
            o.a.createElement(
              ge.a,
              { style: Ge.body },
              o.a.createElement(be.a, null, d),
              ...
              o.a.createElement(De, {
                onCitySelected: function(e) {
                  console.log('city selected:', e),
                    u(Object(a.a)({}, c, { city: { id: e.value } }))
                }
              }),
        ...
        et = Object(D.b)(function(e) {
          var t = e.client,
            n = Object(r.useState)(!1),
            a = Object(_.a)(n, 2),
            i = a[0],
            l = a[1],
            c = Object(r.useState)('all'),
            u = Object(_.a)(c, 2),
            s = u[0],
            m = u[1],
            d = Object(r.useState)({}),
          ...
          Object(r.useEffect)(
            function() {
              t.query({ query: re }).then(function(e) {
                var t = e.data
                v(t.me), y(t.me.venues)
              })
            },
            [t]
          )
          ...
          return o.a.createElement(
            ...
            o.a.createElement(
              ...
              o.a.createElement(
                'div',
                { style: Ye.sectionHeader },
                o.a.createElement(
                  x.a,
                  {
                    variant: 'h5',
                    style: Ye.sectionHeaderTitle,
                    onClick: function() {
                      m('all'), y(f.venues)
                    }
                  },
                ...
                o.a.createElement(Qe, { open: i, toggleDialog: E })
              ),
              ...
              o.a.createElement(
                ...
                b
                  .filter(function(e) {
                    return 'all' === s || e.venueTypes[0].name === s
                  })
                  .map(function(e) {
                    return o.a.createElement(pe, { key: e.id, venue: e })
                  })
              )
            )
          )
        ...
        it = function(e) {
          var t = e.venueId,
            n = (e.venueSlug, e.favoriteByCurrentUser),
            a = [{ query: ne, variables: { venueId: t } }, { query: re }],
            r = Object(He.a)(Fe, {
              onError: function(e) {
                console.log('error', e)
              },
            ...
            n
              ? o.a.createElement(
                  ...
                  o.a.createElement(
                    'a',
                    {
                      href: '#',
                      onClick: function(e) {
                        e.preventDefault(), c({ variables: { venueId: t } })
                      }
                    },
                    'Unlike'
                  )
              ...
              : o.a.createElement(
                  'a',
                  {
                    href: '#',
                    onClick: function(e) {
                      e.preventDefault(), i({ variables: { venueId: t } })
                    }
                  },
                  'Like'
                )
        ...
        ct = function(e) {
          ...
          return t
            ? o.a.createElement(
                Ue.b,
                { query: ae, variables: { venueSlug: t } },
                function(e) {
                  var n = e.loading,
                    a = e.error,
                    r = e.data
                  ...
                  return o.a.createElement(
                    ...
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        ...
                        o.a.createElement(
                          x.a,
                          { variant: 'h5', style: lt.sectionHeader },
                          i.name
                        ),
                        o.a.createElement(
                          'div',
                          { style: lt.columnWrapper },
                          o.a.createElement(
                            'div',
                            { style: lt.mainColumn },
                            o.a.createElement(
                              ...
                              o.a.createElement(
                                ...
                                null,
                                o.a.createElement(Ee.a, {
                                  value: i.venueStats.favorites,
                                  thousandSeparator: !0,
                                  displayType: 'text'
                                }),
                                ' ',
                                nt()('person', i.venueStats.favorites)
                              ),
                              '. \xa0',
                              z() &&
                                o.a.createElement(it, {
                                  ...
                                  venueSlug: t,
                                  favoriteByCurrentUser:
                                    i.venueStats.favoriteByCurrentUser
                                })
                            ),
                            o.a.createElement('br', null),
                            i.description &&
                              o.a.createElement('span', null, i.description),
                            'This ',
                            l,
                            ' is located in ',
                            i.city,
                          ...
                          o.a.createElement(
                            'div',
                            { style: lt.sideColumm },
                            o.a.createElement(ot, { venue: i }),
                            o.a.createElement(rt, { venue: i })
                          )
                        )
                      )
                    )
      ...
      var St,
                  ...
                  return o.a.createElement(
                    ...
                    o.a.createElement(
                      ...
                      c &&
                        o.a.createElement(
                          be.a,
                          { className: u.dialogMainError },
                          c
                        ),
                      o.a.createElement(
                        'div',
                        { className: u.dialogMainContent },
                        !n &&
                          o.a.createElement(
                            'span',
                            null,
                  ...
                  return o.a.createElement(
                    ...
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        ...
                        o.a.createElement($t, { className: t.loginButton }),
                        z() &&
                          o.a.createElement(
                            'span',
        ...
        Ut = Object(a.a)({}, Vt, {
          container: {
            ...
            borderBottomColor: gt.a[100],
            backgroundColor: 'white'
          },
          grow: Object(a.a)({}, Vt.grow, { color: gt.a[500] }),
          menuButton: Object(a.a)({}, Vt.menuButton, { color: gt.a[500] }),
          loginButton: { color: gt.a[500] },
          logoText: { color: gt.a[500] }
        }),
        Mt = Object(E.f)(function(e) {
          var t = j(e.location) ? Vt : Ut,
            n = Object(le.a)(t)(Bt)
                  ...
                  return o.a.createElement(
                    ...
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        ...
                        o.a.createElement(E.a, { path: O.venue, component: ct })
                      )
                    )
                  )
                }
      ...
      var zt = new u.a(),
        ...
        Ft = localStorage.getItem('auth-token'),
        _t = new s.a({
          uri: 'http://api.mykidtrip.com',
          credentials: 'same-origin',
          headers: { authorization: Ft ? 'Bearer '.concat(Ft) : '' }
        }),
        Ht = new c.a({
          link: d.a.from([
      ...
      l.a.render(
        o.a.createElement(
          de.a,
          null,
          o.a.createElement(p.b, { client: Ht }, o.a.createElement(At, null))
        ),
...
//# sourceMappingURL=main.f4868ad9.chunk.js.map

      ...
      var Qn = ae(
        Ft(({ match: e, currentUser: t }) => {
          const n = Object(r.useState)(null),
            ...
            h = Object(c.useQuery)(jn, { fetchPolicy: 'network-only' }),
            O = h.loading,
            j = h.error,
            N = h.data,
            I = Object(c.useLazyQuery)(Nn, {
              fetchPolicy: 'no-cache',
              onCompleted: t => {
                y(t.conversation),
                  T(t.conversation),
                  $() && x({ variables: { publicId: e.params.publicId } })
              }
            }),
            S = Object(le.a)(I, 1)[0],
            C = Object(c.useLazyQuery)(X, {
              onCompleted: e => {
                e &&
                  e.userProfile &&
                  e.userProfile.user &&
          ...
          Object(r.useEffect)(() => {
            N && N.conversationalists && f(N.conversationalists)
          }, [N]),
            Object(r.useEffect)(() => {
              const t = e.params.publicId
                ...
                : null
              var n
              s(t), t && S({ variables: { conversationalistUserId: t } })
            }, [e.params.publicId, S]),
            Object(r.useEffect)(() => {
              U()
            }, [g])
            ...
            : o.a.createElement(
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(Rn, {
                    ...
                    onMessageCreated: () => {
                      S({ variables: { conversationalistUserId: l } })
                    }
                  })
                )
              )
...
//# sourceMappingURL=main.1d1c1bbd.chunk.js.map
